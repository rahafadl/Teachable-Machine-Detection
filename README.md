...
🔹 ملاحظة هامة: لا تنسَ إرفاق ملفات النموذج داخل مجلد my_model/ قبل تشغيل المشروع!
يجب أن يحتوي هذا المجلد على الملفات التالية التي يتم تصديرها من Teachable Machine بعد تدريب النموذج:
